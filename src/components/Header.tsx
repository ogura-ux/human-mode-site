    ...
    >
      <div className="max-w-[1080px] mx-auto px-6 flex justify-between items-center">
        ...
        <nav className="flex gap-8 items-center">
          ...
          <Link
            href="/dev"
            className="bg-brand text-white px-6 py-2.5 rounded-full text-sm font-bold shadow-[0_4px_14px_rgba(12,157,121,0.2)] hover:shadow-[0_6px_20px_rgba(12,157,121,0.35)] hover:-translate-y-0.5 transition-all"
          >
            受託開発相談
          </Link>
        </nav>
